...
class _$SeriesImpl implements _Series {
  ...
  @override
  String toString() {
    return 'Series(author: $author, title: $title, description: $description, url: $url, image: $image, publishDate: $publishDate)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, author, title, description, url, image, publishDate);
...
abstract class _Series implements Series {
  const factory _Series(
      ...
      required final DateTime publishDate}) = _$SeriesImpl;
